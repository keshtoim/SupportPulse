...
// Частые вопросительные/служебные слова без собственного тематического смысла. Почти каждый вопрос
// в базе знаний начинается с "как" — без фильтра оно совпадало бы буквально со всеми статьями сразу
// и давало одинаковый +1 к релевантности каждой, забивая полезный сигнал от содержательных слов.
const stopwords = new Set([
  "как", "что", "где", "кто", "чем", "для", "это", "эта", "эту", "эти", "этот",
  "вас", "вам", "при", "или", "если", "мне", "мой", "моя", "мои", "его", "её",
  "их", "они", "она", "он", "мы", "вы", "но", "да", "нет", "то", "так", "все", "всё"
]);

/** Разбивает строку на токены (слова), отфильтровывая короткие и служебные */
